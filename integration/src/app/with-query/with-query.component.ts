...
@Injectable()
export class WithQueryMediatorConfig extends MediatorConfiguration<
  string,
...
@Component({
  selector: 'app-with-query',
  template: `
    <input #myquery placeholder="Enter Post-ID ..." />
    <mtm-table
      [sortable]="true"
  ...
  `,
  styleUrls: ['./with-query.component.css'],
  providers: [{ provide: MediatorConfiguration, useClass: WithQueryMediatorConfig }]
})
export class WithQueryComponent implements AfterViewInit {
